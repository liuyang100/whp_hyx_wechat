<template>
	<view v-if="visibleSync" :class="{ 'uni-drawer--visible': showDrawer }" class="uni-drawer">
		...
		<view class="uni-drawer__content" :class="{ 'uni-drawer--right': rightMode, 'uni-drawer--left': !rightMode, 'uni-drawer__content--visible': showDrawer }">
			<!-- start -->
			<view class="tki-tree">
				<view class="tki-tree-mask show"></view>
				<view class="tki-tree-cnt show"  >
					<view class="tki-tree-bar">
						<view class="tki-tree-bar-cancel" :style="{ color: cancelColor }" hover-class="hover-c" @tap="close">取消</view>
