			...
			<view class="uni-list-item__container" :class="{ 'uni-list-item--first': isFirstChild }">
				...
				<view class="uni-list-item__content">
					...
					<view class="uni-list-item__content-title">
						<text v-if="must" style="display: inline; color: #FF0000">*</text>
						{{ title }}
					</view>
				...
				<view v-if="showBadge || showArrow || showSwitch" class="uni-list-item__extra">
					<text
						v-if="rightText"
						:style="{ fontSize: rightTextFont + 'rpx', color: rightTextColor }"
						style="max-width: 500upx;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"
					>
						{{ rightText }}
					</text>
